# 1. Table 1
## 1.1 Characteristic comparison at baseline and induction IIT
...
## 1.2 Characteristic comparison after 3-weeks of induction IIT
...
## 1.3 Change from baseline to 3-weeks
